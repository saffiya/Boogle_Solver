...
class TestBoggle(unittest.TestCase):
    """
    Our test suite for boggle solevr
    """
    ...
    def test_grid_coordinates(self):
        """
        Test to ensure that all of the coordiantes inside of the grid can be accessed
        """
    ...
    def test_grid_is_filled_with_letters(self):
        """
        Ensure that each of the coordinators in the grid contains letters
        """
